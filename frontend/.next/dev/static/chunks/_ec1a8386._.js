    ...
    const recordTransaction = (transaction)=>{
        ...
        if (transaction.type === "deposit") {
            toast({
                ...
                description: `Successfully deposited $${transaction.amount.toFixed(2)} for this market.`,
                variant: "default"
            });
        } else {
            ...
            toast({
                ...
                description: `${actionText} bet of $${transaction.amount.toFixed(2)} placed for ${transaction.optionName} (${transaction.selection?.toUpperCase()}).`,
                variant: "default"
            });
        }
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: ()=>{
                                                                ...
                                                                if (canPlace) {
                                                                    ...
                                                                    // Record transaction - Scenario 2: Place Bet
                                                                    recordTransaction({
                                                                        type: "bet",
                                                                        marketId: marketId,
                                                            ...
                                                            disabled: !allocation.amount || allocation.amount <= 0 || (allocation.buySellMode === "sell" ? allocation.amount > getAvailableToSell(optionIndex, allocation.selection) : allocation.amount > tradingBalance - getOptionTotalAllocation(optionIndex) + allocation.amount) || placedAllocations.has(optionIndex),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    if (unplacedOptions.length > 0) {
                                        setPlacedAllocations((prev)=>{
                                            ...
                                            unplacedOptions.forEach((alloc)=>{
                                                ...
                                                // Record transaction - Scenario 2: Place Bet (for each allocation)
                                                recordTransaction({
                                                    type: "bet",
                                                    marketId: marketId,
                                                    marketQuestion: market?.question,
                                ...
                                }) || Object.values(allocations).every((alloc)=>!alloc.selection || alloc.amount <= 0 || placedAllocations.has(alloc.optionIndex)),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>{
                                        ...
                                        if (amount > 0 && amount <= userBalance) {
                                            ...
                                            // Record transaction - Scenario 1: Deposit
                                            recordTransaction({
                                                type: "deposit",
                                                marketId: marketId,
                                                marketQuestion: market?.question,
...
_s(MarketDetailPage, "QM4eTdk8Ze3Uk2pDpnn4be/6INo=", false, function() {
    return [
...
//# sourceMappingURL=_ec1a8386._.js.map
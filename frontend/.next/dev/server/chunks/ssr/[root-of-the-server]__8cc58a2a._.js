...
;
const metadata = {
    title: "Prediction Market Designs - 6 Variations",
    description: "Design showcase for prediction market app with multi-option predictions, live odds, and social features",
    generator: "v0.app",
    icons: {
        icon: [
            {
